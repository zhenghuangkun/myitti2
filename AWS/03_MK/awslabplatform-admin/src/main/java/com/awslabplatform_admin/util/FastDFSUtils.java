...
public class FastDFSUtils {
	public static com.awslabplatform_admin.entity.FileInfo uploadPic(byte[] pic, String name, long size) throws IOException {
		String path = null;
		//ClientGlobal 读取配置文件
		ImageIO.setUseCache(false);
		ClassPathResource resource = new ClassPathResource("fdfs_client.conf");
		//FileInfo对象填充
		com.awslabplatform_admin.entity.FileInfo fileInfo = new com.awslabplatform_admin.entity.FileInfo();
		...
		try {
			...
			fileInfo.setOperator(ShiroUtil.getCurrentUserId());
