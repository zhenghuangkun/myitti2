package com.awslabplatform_admin.common.message;
...
public enum IamMessage implements Message {
	...
	EXIST_IAMPOOl_DATA(10108 , "AccountID或IMA User已经存在,请重新输入！"),
	ADD_IAMPOOL_SUCCES(10109 , "添加数据信息成功!"),
	EDIT_IAMPOOl_ERROR(10110, "编辑院系AWS账号数据信息失败!"),
	EDIT_IAMPOOl_SUCCESS(10111, "编辑院系AWS账号数据信息成功!"),
	EDIT_ACCOUNTOOl_ERROR(10112, "AccountID或IMA User已经存在,请重新编辑!");
