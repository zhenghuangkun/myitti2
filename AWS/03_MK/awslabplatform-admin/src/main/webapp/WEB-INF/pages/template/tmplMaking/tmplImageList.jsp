	...
	<body class="skin-1">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-6 col-sm-4 pull-right">
								<div class="input-group">
									<input type="text" class="form-control search-query" id="keyword" placeholder="请输入镜像ID" />
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="table-header">镜像列表</div>
								<table id="imageTb" class="table table-striped table-hover"></table>
							</div>
						</div>
			...
			<%@ include file="/WEB-INF/pages/common/footer.jsp" %>
				...
				<!-- 模态框（Modal） -->
		<div id="imageEditModel" class="modal" tabindex="-1">
		    <div class="modal-dialog">
		        <div class="modal-content">
		            <div class="modal-header">
		                <button type="button" class="close" data-dismiss="modal" >&times;</button>
		                <h4 class="blue bigger" >镜像修改</h4>
		            </div>
		            <div class="modal-body">
		            	<div class="form-horizontal"  id="imageMakeForm">
							 <div class="form-group">
								...
								<div class="col-sm-8">
									<textarea  id="imageDescribe" class="form-control" name="imageDescribe" rows="10" maxlength="500"></textarea>
								</div>
							 </div>
						</div>
					</div>
		            <div class="modal-footer">
		                <button type="button" class="btn btn-primary btn-round" id="editSubmit">确定</button>
		...
		<script type= "text/javascript" src="${pageContext.request.contextPath}/resource/js/template/tmplMaking/tmplImageList.js"></script>
