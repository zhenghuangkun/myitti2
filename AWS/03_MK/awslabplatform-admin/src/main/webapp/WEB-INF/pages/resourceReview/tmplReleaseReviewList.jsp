...
<html>
	...
	<body class="skin-1">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-6 col-sm-6">
								<ul class="nav nav-pills">
									<li>
										<a role="button" href="${pageContext.request.contextPath}/tmplreview/list/tmplReviewList">模板试用审核</a>
									</li>
									<li class="active">
										<a role="button" href="${pageContext.request.contextPath}/tmplreview/list/tmplReleaseReviewList">模板发布审核</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="table-header">模板发布审核列表</div>
								<table id="tmplReleaseTb" class="table table-striped table-hover"></table>
							</div>
						</div>
					</div><!-- /.page-content -->
		...
		<script src="${pageContext.request.contextPath}/resource/js/resourceReview/tmplReleaseReviewList.js"></script>
