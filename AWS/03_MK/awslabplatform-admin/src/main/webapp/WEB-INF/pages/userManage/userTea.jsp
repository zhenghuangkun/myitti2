		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-header">老师管理列表</div>
		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 id="addh4" class="modal-title">添加用户信息</h4>
			            <h4 id="edith4" class="modal-title">编辑用户信息</h4>
		            </div>
		             <div class="clearfix">
					...
					<div class="modal-footer">
				     	...
				     	<input type="hidden" name="roleType" id="roleType" value='3' />
					    ...
					    <input type="hidden" name="iamType" id="iamType" value="theacher" />
