		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-header">院系管理列表</div>
		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            <div class="modal-header">
		                ...
		                <h4 id="addh4" class="modal-title">添加院系用户信息</h4>
			            <h4 id="edith4" class="modal-title">编辑院系用户信息</h4>
		            </div>
		             <div class="clearfix">
		            ...
		            <div class="modal-body">
						 ...
						 <div class="form-group" id="awsAccountDiv">
						 	<label class="col-sm-1 control-label no-padding-right" ><img src="${pageContext.request.contextPath}/resource/images/circular.png"></img></label>
							<label class="col-sm-3 control-label no-padding-right" >AwsAccount账户:</label>
							<label class="col-sm-1 control-label"  id="awsAccountId"></label>
							<label class="col-sm-3 control-label no-padding-right" >主账户:</label>
							<label class="col-sm-1 control-label"  id="payingAccountId"></label>
						 </div>
						 <div class="form-group">
					...
					<div class="modal-footer">
				     	...
				     	<input type="hidden" name="roleType" id="roleType" value='2' />
					    <input type="hidden" name="copyPhoneNum" id="copyPhoneNum" />
					    <input type="hidden" name="copyEmail" id="copyEmail" />
					    <input type="hidden" name="isAwsIam" id="isAwsIams" value="0"/>
					    <input type="hidden" name="copyIamName" id="copyIamName" />
					    <input type="hidden" name="iamType" id="iamType" value="depatment" />
