...
<html>
	...
	<body class="no-skin">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-8">
							...
							<div class="profile-user-info profile-user-info-striped">
								...
								<div class="profile-info-row">
									<div class="profile-info-name"> 源模板 </div>

									<div class="profile-info-value">
										<span>${tmplate.associatedTmplName}</span>
									</div>
								</div>
		...
		<script src="${pageContext.request.contextPath}/resource/js/template/tmplMaking/tmplMakeInfoRead.js"></script>
