...
<html>
	...
	<body class="skin-1">
		...
		<div class="main-container ace-save-state" id="main-container">
					...
					<div class="page-content">
						...
						<div class="add tableTools-container">
							...
							<div class="layui-inline" style="width:250px;float:right;">
							 	<a href="${pageContext.request.contextPath}/resource/excelModel/excelModel.xls" class="btn btn-info btn-sm"><i class='ace-icon fa fa-hand-o-down bigger-120'> </i>下载模板</a>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<table id="stuTb" class="table table-striped table-hover">
		  ...
		  <!-- 添加、编辑用户模态框（Modal） -->
		 <form class="form-horizontal" method="post" action="" role="form" id="userStuForm" >
			<div class="modal fade" id="userStuModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            <div class="modal-header">
			                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			             <h4 id="addh4" class="modal-title">添加学生信息</h4>
			            <h4 id="edith4" class="modal-title">编辑学生信息</h4>
			            </div>
			            ...
			            <div class="modal-body">
			             <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" >学号：&nbsp;<span style="color: red">*</span></label>
								<div class="col-sm-8">
									<input type="text"  class="form-control" name="stuId" id="stuId" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入数字" maxlength="12"/>
								</div>
						 </div>
						 <div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" >姓名：&nbsp;<span style="color: red">*</span></label>
							<div class="col-sm-8">
								<input type="text"  class="form-control" name="realName" id="realName" placeholder="请填写真实姓名" maxlength="20"/>
							</div>
						 </div>
							 
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" >学校名称：&nbsp;<span style="color: red">*</span></label>
							<div class="col-sm-8">
								<select id="schoolId" name="schoolId" class="form-control">
									<option value="-1">请选择学校名称</option>
								</select>
							</div>
							<div class="col-sm-1" style="padding-left:0px;padding-right:0px;">
							 ...
							 <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" >所属学院：&nbsp;<span style="color: red">*</span></label>
								<div class="col-sm-8">
									<select  name="mechanismId" class="form-control" id="mechanismId">
							 ...
							 <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" >专业：&nbsp;<span style="color: red">*</span></label>
								<div class="col-sm-8">
							 ...
							 <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" >年级：&nbsp;<span style="color: red">*</span></label>
								<div class="col-sm-8">
							 ...
							 <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" >班级：&nbsp;<span style="color: red">*</span></label>
								<div class="col-sm-8">
							 ...
							 <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" >住址：</label>
								<div class="col-sm-8">
									<input type="text" id="address" class="form-control" name="address" maxlength="40"/>
								</div>
							 </div>							 
						</div>
						<div class="modal-footer">
							<input type="hidden" name="id" id="id" />
							<input type="hidden" name="copyStuId" id="copyStuId" />
							<input type="hidden" name="copyPhoneNum" id="copyPhoneNum" />
							<input type="hidden" name="copyEmail" id="copyEmail" />
							<input type="hidden" name="iamType" id="iamType" value="stu" />
			...
			<script src="${pageContext.request.contextPath}/resource/js/userManage/studentManage.js"></script><!-- 引入平台管理学生脚本 -->
	</body>
</html>