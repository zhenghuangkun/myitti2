...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/courseManage/courseStyle.css"/>
</head>
...
<body class="skin-1">
								...
								<div class="widget-main">
									...
									<form class="form-horizontal from-course-class" id="addCourseFrom" method="POST" action="" enctype="multipart/form-data">
										...
										<div class="col-xs-12 col-sm-12 col-md-12" style="background-color: #f7f8fb; border:1px solid #dfe3ed">
												...
												<div class="col-xs-12 col-sm-4">
													<div class="openRange">
														<label class="line-height-0 blue" >
															<input name="openRange" value="0" class="ace ace-courseOpenRange" id="courseOpenRange1" type="radio" checked="checked"/>
															<span class="lbl" style="font-size:16px;"> 学生</span>
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label class="line-height-0 blue">
															<input name="openRange" value="1" class="ace ace-courseOpenRange" id="courseOpenRange2" type="radio"/>
															<span class="lbl"> 院系</span>
														</label>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<label class="line-height-0 blue">
															<input name="openRange" value="2" class="ace ace-courseOpenRange" id="courseOpenRange3" type="radio"/>
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-2 startUpType">
													<input id="courseStartUpTypeVal" name="courseStartUpTypeVal" type="checkbox" checked="checked" class="ace ace-switch ace-switch-5">
											...
											<div class="form-group" id="courseStartTimeConfig">
												...
												<div class="col-xs-12 col-sm-4">
													<div class="input-group input-group-sm myweidth">
														<input class="form-control laydatetime" id="myDatepickerInput" name="courseStratTime" type="text"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-xs-12 col-sm-12 col-md-12" style="background-color: #f7f8fb; border:1px solid #dfe3ed">
													...
													<div class="clearfix myweidth">
														<select id="courseType" name="courseType" class="select2" data-placeholder="请选择类型...">
															...
															<c:forEach items="${courseTypeList}" var="courseType">
																<option value="${courseType.itemId}">${courseType.itemName}</option>
															</c:forEach>
														</select>
													</div>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-4">
													<div class="clearfix myweidth">
														<!-- 课程名，不能为空 -->
														<input name="courseName" id="courseName" class="col-xs-12 col-sm-12" type="text" placeholder="课程名称" required="required" maxlength="30" style="border-radius:4px">
													...
													<div class="clearfix myweidth">
														<select class="levelselect" id="courseTypeLevel" name="courseTypeLevel" style="width:100%" data-placeholder="请选择等级...">
															...
															<c:forEach items="${courseLevelList}" var="courseTypeLevel">
																<option value="${courseTypeLevel.itemId}">${courseTypeLevel.itemName}</option>
															</c:forEach>
														</select>
													</div>
												</div>			
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-4">
													<div class="clearfix coursePictureClass">
														<!-- <input name="coursePic" id="coursePic" class="col-xs-12 col-sm-6" type="file"> -->
														<a href="javascript:void(0)" id="coursePic" style="width:200px;display:block;">
															<img src="${pageContext.request.contextPath}/resource/images/courseManage/uploadDefault.png" class="img-responsive" alt="请选择图片" id="coursePicImg">
														</a>
													</div>
												</div>
												
												<!-- <div class="col-xs-12 col-sm-4">
													<button class="btn btn-app btn-light" style="width: 250px;height:200px;background-color: blue">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-6">
													<div class="clearfix">
														<textarea class="input-xxlarge valid textarea-class" name="description" id="description" onkeydown="displayWordCound(this,500)" onkeyup="displayWordCound(this, 500)" onfocus="displayWordCound(this, 500)" maxlength="500" placeholder="请输入课程描述、课程要求、课程目标..."  style="height: 65px;"></textarea>
													</div>
												</div>
												<br/><br/><br/><span id="description-total">0</span>/500
											</div>
										...
										<div class="col-xs-12 col-sm-12 col-md-12" style="background-color: #f7f8fb; border:1px solid #dfe3ed">
											...
											<table id="courseExperimentTB" class="table table-striped table-hover" style="width:100%;">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resource/pulgins/ajaxfileupload.js"></script>
	...
	<!-- 引入用户管理脚本 -->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/courseManage/add-course.js"></script>
