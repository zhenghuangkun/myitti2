...
<html>
	...
	<body class="skin-1">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="table-header">模板试用审核列表</div>
								<table id="tmplReviewTb" class="table table-striped table-hover"></table>
							</div>
						</div>
					</div><!-- /.page-content -->
		...
		<script src="${pageContext.request.contextPath}/resource/js/resourceReview/tmplReviewList.js"></script>
