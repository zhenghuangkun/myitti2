...
typedef struct NGAP_NPN_MobilityInformation {
	...
	union NGAP_NPN_MobilityInformation_u {
		NGAP_SNPN_MobilityInformation_t	 sNPN_MobilityInformation;
		NGAP_PNI_NPN_MobilityInformation_t	 pNI_NPN_MobilityInformation;
		NGAP_ProtocolIE_SingleContainer_9337P22_t	 choice_Extensions;
	} choice;
