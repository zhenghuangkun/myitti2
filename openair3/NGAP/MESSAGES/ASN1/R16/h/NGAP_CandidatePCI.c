...
asn_TYPE_member_t asn_MBR_NGAP_CandidatePCI_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_CandidatePCI, candidatePCI),
		...
		0,
		{ 0, &asn_PER_memb_NGAP_candidatePCI_constr_2,  memb_NGAP_candidatePCI_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_CandidatePCI, candidateNRARFCN),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NGAP_candidateNRARFCN_constr_3,  memb_NGAP_candidateNRARFCN_constraint_1 },
		0, 0, /* No default value */
		"candidateNRARFCN"
		},
	{ ATF_POINTER, 1, offsetof(struct NGAP_CandidatePCI, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_9385P25,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
