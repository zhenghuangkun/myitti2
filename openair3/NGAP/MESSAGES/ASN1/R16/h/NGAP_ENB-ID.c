...
asn_TYPE_member_t asn_MBR_NGAP_ENB_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_ENB_ID, choice.macroENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_macroENB_ID_constr_2,  memb_NGAP_macroENB_ID_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_ENB_ID, choice.homeENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_homeENB_ID_constr_3,  memb_NGAP_homeENB_ID_constraint_1 },
		0, 0, /* No default value */
		"homeENB-ID"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_ENB_ID, choice.short_macroENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_short_macroENB_ID_constr_4,  memb_NGAP_short_macroENB_ID_constraint_1 },
		0, 0, /* No default value */
		"short-macroENB-ID"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_ENB_ID, choice.long_macroENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_long_macroENB_ID_constr_5,  memb_NGAP_long_macroENB_ID_constraint_1 },
		0, 0, /* No default value */
		"long-macroENB-ID"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_ENB_ID, choice.choice_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolIE_SingleContainer_9337P10,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
asn_TYPE_descriptor_t asn_DEF_NGAP_ENB_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_NGAP_ENB_ID_constr_1, CHOICE_constraint },
