...
static asn_TYPE_member_t asn_MBR_NGAP_MDT_Configuration_1[] = {
	{ ATF_POINTER, 2, offsetof(struct NGAP_MDT_Configuration, mdt_Config_NR),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_MDT_Configuration, mdt_Config_EUTRA),
...
static const int asn_MAP_NGAP_MDT_Configuration_oms_1[] = { 0, 1 };
