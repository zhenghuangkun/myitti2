...
asn_TYPE_member_t asn_MBR_NGAP_IntersystemSONTransferType_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_IntersystemSONTransferType, choice.fromEUTRANtoNGRAN),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_IntersystemSONTransferType, choice.fromNGRANtoEUTRAN),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_IntersystemSONTransferType, choice.choice_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolIE_SingleContainer_9337P13,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
asn_TYPE_descriptor_t asn_DEF_NGAP_IntersystemSONTransferType = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_NGAP_IntersystemSONTransferType_constr_1, CHOICE_constraint },
