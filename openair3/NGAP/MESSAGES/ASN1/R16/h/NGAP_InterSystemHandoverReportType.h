...
typedef struct NGAP_InterSystemHandoverReportType {
	...
	union NGAP_InterSystemHandoverReportType_u {
		NGAP_TooearlyIntersystemHO_t	 tooearlyIntersystemHO;
		NGAP_IntersystemUnnecessaryHO_t	 intersystemUnnecessaryHO;
		NGAP_ProtocolIE_SingleContainer_9337P16_t	 choice_Extensions;
	} choice;
