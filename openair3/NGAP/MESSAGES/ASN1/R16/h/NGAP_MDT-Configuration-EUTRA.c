...
asn_TYPE_member_t asn_MBR_NGAP_MDT_Configuration_EUTRA_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_MDT_Configuration_EUTRA, signallingBasedMDTPLMNList),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_MDT_Configuration_EUTRA, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_9385P114,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NGAP_MDT_Configuration_EUTRA_oms_1[] = { 4 };
