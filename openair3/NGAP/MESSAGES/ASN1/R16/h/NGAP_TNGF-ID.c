...
asn_TYPE_member_t asn_MBR_NGAP_TNGF_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_TNGF_ID, choice.tNGF_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_tNGF_ID_constr_2,  memb_NGAP_tNGF_ID_constraint_1 },
		0, 0, /* No default value */
		"tNGF-ID"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_TNGF_ID, choice.choice_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolIE_SingleContainer_9337P32,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
asn_TYPE_descriptor_t asn_DEF_NGAP_TNGF_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_NGAP_TNGF_ID_constr_1, CHOICE_constraint },
