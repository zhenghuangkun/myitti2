...
asn_TYPE_descriptor_t asn_DEF_NGAP_earlyIRATHO_4 = {
	...
	{ 0, &asn_PER_type_NGAP_earlyIRATHO_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NGAP_IntersystemUnnecessaryHO_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_IntersystemUnnecessaryHO, failurecellID),
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_IntersystemUnnecessaryHO, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_9385P104,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
