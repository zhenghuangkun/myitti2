...
asn_TYPE_member_t asn_MBR_NGAP_MDT_Location_Info_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_MDT_Location_Info, mDT_Location_Infoormation),
		...
		"mDT-Location-Infoormation"
		},
	{ ATF_POINTER, 1, offsetof(struct NGAP_MDT_Location_Info, iE_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_9385P122,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const asn_TYPE_tag2member_t asn_MAP_NGAP_MDT_Location_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mDT-Location-Infoormation */
